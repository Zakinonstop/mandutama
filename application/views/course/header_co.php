...
<head>
          ...
          <link href="<?php echo base_url() . 'assets/img/logo-mmt.png' ?>" rel="apple-touch-icon">
          ...
          <link href="<?php echo base_url() . 'assets/css/accord.css' ?>" rel="stylesheet">
          ...
          <header id="header" class="d-flex">
                    <div class="container d-flex align-items-center justify-content-between">
                              ...
                              <nav id="navbar" class="navbar">
                                        <ul>
                                                  <li><a class="nav-link scrollto" href="<?php echo base_url() . 'course' ?>">Home </a></li>
                                                  ...
                                                  <li><a class="nav-link scrollto" href="<?php echo base_url() . 'course' ?>">Implementation</a></li>
