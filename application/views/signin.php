...
<head>
  ...
  <title>Sign In - PT Mandutama Multisarana Teknik</title>
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
          <form action="<?php echo base_url('signin/aksi_signin'); ?>" method="post">
            ...
            <div class="text-center text-lg-start mt-4 pt-2">
              <button type="submit" class="btn btn-info btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;">Sign In</button>
